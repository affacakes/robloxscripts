	...
	game:GetService("RunService").Heartbeat:Connect(function(deltaTime)
		if AllowRunService == true then
			if _G.FlareGunESP == true then
              ...
              if v.Name == "FlareGunPickUp" and v:IsA("BasePart") then  -- Ensure it's a BasePart
                  -- Check if the FlareGunChams already exists
                  local FlareGunChams = v:FindFirstChild("FlareGunChams")
        
                  if not FlareGunChams then
                     -- Create a new Highlight if it doesn't exist
                     FlareGunChams = Instance.new("Highlight")
                     ...
                     FlareGunChams.OutlineTransparency = 0.8
